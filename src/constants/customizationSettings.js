...
export const USER_COLORS = {
    ...
    ICONCOLOR_CUSTOM_OCEANBLUE: "#0077BE",
    ICONCOLOR_CUSTOM_CYAN: "#00BCD4",
    ICONCOLOR_CUSTOM_AQUA: "#41CFBE",
    ICONCOLOR_CUSTOM_TEAL: "#008080",
    ICONCOLOR_CUSTOM_DARKBLUE: "#1C7195",
    ICONCOLOR_CUSTOM_MIDNIGHTBLUE: "#003366",

    // Grüntöne
    ICONCOLOR_CUSTOM_EMERALD: "#4CAF50",
    ICONCOLOR_CUSTOM_LIGHTGREEN: "#9DD622",
    ICONCOLOR_CUSTOM_DARKGREEN: "#1E7808",

    // Gelb und Orangetöne
    ICONCOLOR_CUSTOM_YELLOW: "#FFEB3B",
    ICONCOLOR_CUSTOM_AMBER: "#FFC107",
    ICONCOLOR_CUSTOM_SUNSETORANGE: "#FF7043",
    ICONCOLOR_CUSTOM_DEEPORANGE: "#FF5722",
    ...
    ICONCOLOR_CUSTOM_PURPLE: "#9C27B0",
    ICONCOLOR_CUSTOM_MAGENTA: "#FF00FF",

    // Grautöne und Neutrale
    ICONCOLOR_CUSTOM_GREY: "#646D71",
    ICONCOLOR_CUSTOM_CHARCOAL: "#304049",
    ICONCOLOR_CUSTOM_SLATE: "#607D8B",
    ICONCOLOR_CUSTOM_BROWN: "#795548",
